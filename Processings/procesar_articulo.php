...
switch ($accion) {
    ...
    case 'cambiar_estado':
        ...
        // Cambiar estado - MODIFICADO para usar texto en lugar de valor numérico
        $id = intval($_POST['id']);
        $estado = $_POST['estado']; // Ahora acepta directamente 'activo' o 'inactivo'
        ...
        if (isset($resultado['error']) && $resultado['error']) {
            ...
            $_SESSION['mensaje'] = ($estado === 'activo') ?
